...
function t_guide() {
	add_theme_page('How to use Iris theme', 'Iris user guide', 8, 'user_guide', 't_guide_options');
...
<h2 style="clear:both; padding:20px 10px; color:#444; font-size:32px; background:#eee">Iris: User guide</h2>
</div>
