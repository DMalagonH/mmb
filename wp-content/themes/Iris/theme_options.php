...
$options = array (
	...
	array("name" => "Welcome message on the header ",
			"desc" => "Type in your welcome text .",
            "id" => $shortname."_welc",
            "std" => "Welcome to my website. This is a sample text to introduce myself and the site. This will be replaced soon",
            "type" => "textarea"), 
