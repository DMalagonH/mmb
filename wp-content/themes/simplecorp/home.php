			...
			<div id="content" class="clearfix">
				...
				<div class="container clearfix">
					...
					<div class="one-half">
						...
						<p class="readmore">
							<a href="<?php echo of_get_option('sc_homecontent1url') ?>"><?php _e('Leer más…', 'site5framework') ?></a>
						</p>
						<?php } ?>
					</div>
					<?php endif ?>
					...
					<div class="one-half last">
						...
						<p class="readmore">
							<a href="<?php echo of_get_option('sc_homecontent2url') ?>"><?php _e('Leer más…', 'site5framework') ?></a>
						</p>
						<?php } ?>
					</div>
					<?php endif ?>
				...
				<div class="container clearfix">
					...
					<div class="one-half">
						...
						<p class="readmore">
							<a href="<?php echo of_get_option('sc_homecontent3url') ?>"><?php _e('Leer más…', 'site5framework') ?></a>
						</p>
						<?php } ?>
					</div>
					<?php endif ?>
					...
					<div class="one-half last">
						...
						<p class="readmore">
							<a href="<?php echo of_get_option('sc_homecontent4url') ?>"><?php _e('Leer más…', 'site5framework') ?></a>
						</p>
						<?php } ?>
					</div>
					<?php endif ?>
