...
/**
* 
* Graphite, a Free Wordpress Theme by MediaLoot.com
* 
*
*
**/
...
add_action('wp_footer', 'g_theme_bot');
...
function g_theme_bot(){

$top = <<<EOH
<p id="medialoot" ><a href="http://medialoot.com">Graphite theme by MediaLoot</p>
		</div><!-- end .wrapper -->
</section>
EOH;
